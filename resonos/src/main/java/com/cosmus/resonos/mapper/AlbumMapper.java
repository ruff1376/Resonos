...
public interface AlbumMapper {
    ...
    // 좋아요한 앨범 전체
    public List<Album> likedAlbums(@Param("id") Long id, @Param("keyword") String keyword, @Param("offset") int offset, @Param("limit") int limit) throws Exception;
    // 좋아요한 앨범 수
    public int countLikedAlbums(@Param("id") Long id) throws Exception;
    // 전체 앨범 데이터 불러오기
